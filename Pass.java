...
public abstract class Pass {
    ...
    protected boolean isEntryPoint(int nibble) {
        if (nibble == 0 || nibble == 2) return true;
        return false;
    }
     ...
     */
    protected boolean isRelocableEntryPoint(int nibble) { return nibble == 2; }
     ...
     */
    protected boolean isRelocable(int nibble) { return nibble > 7; }
     ...
     */
    protected boolean isResolved(int nibble) { return (nibble>>2) % 2 == 0; }
     ...
     */
    protected boolean isArgumentRelocable(int nibble) { return (nibble>>1) % 2 > 0; }
     ...
     */
    protected boolean isExternalPseudoInstruction(int nibble) { return nibble == 4; }
     ...
     *
     */
    protected boolean instructionWithExternal(int nibble) { return nibble%2) > 0; }
